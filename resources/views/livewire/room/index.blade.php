        ...
        <main class="w-full">
            <div x-data="{nav: false}" @mouseover="nav = true" @mouseleave="nav = false"
                ...
                <div x-show="nav" class="text-center mt-2 text-gray-500">
                    <button @click="$refs.video.width=$refs.video.width+64" class="text-lg"><svg aria-hidden="true"
                            focusable="false" data-prefix="fas" data-icon="magnifying-glass-plus" class="h-8 w-8"
                    ...
                    <button @click="$refs.video.width=$refs.video.width-64" class="text-lg ml-8"><svg aria-hidden="true"
                            focusable="false" data-prefix="fas" data-icon="magnifying-glass-minus" class="h-8 w-8"
                            role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path fill="currentColor"
                    ...
                    <button @click="$refs.video.requestFullscreen()" class="text-lg ml-8"><svg aria-hidden="true"
                            focusable="false" data-prefix="fas" data-icon="expand" class="h-8 w-8" role="img"
