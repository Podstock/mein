<div x-data="{messages: []}" @message.window="messages.push($event.detail.msg)" x-show="$wire.show" x-cloak
    ...
    <div class="hidden md:flex w-screen max-w-md"></div>
                    ...
                    <div class="hidden border-b border-gray-200">
                        <div class="px-6">
                            <nav class="-mb-px flex space-x-4">
                                ...
                                <a href="#"
                                    class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pb-4 px-1 border-b-2 font-medium text-sm">Shownotes</a>

                                <a href="#"
                                    class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pb-4 px-1 border-b-2 font-medium text-sm">Intern</a>
                            </nav>
                        </div>
                    </div>
