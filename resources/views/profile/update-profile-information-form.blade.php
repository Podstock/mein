<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <!-- sendegate -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="sendegate" value="{{ __('Name im Sendegate') }}" />
            <x-jet-input id="sendegate" type="text" class="mt-1 block w-full" wire:model.defer="state.sendegate"
                placeholder="name" />
            <x-jet-input-error for="sendegate" class="mt-2" />
        </div>
