<div x-data="{nav: false}" @mouseover="nav = true" @mouseleave="nav = false" x-show="$store.webrtc_video.webrtc_video" x-cloak>
    <div x-show="nav" class="text-center mt-2 text-gray-500">
        <button @click="$refs.video.width=$refs.video.width+64" class="text-lg" title="Vergößern">
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="magnifying-glass-plus" class="h-8 w-8" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <button @click="$refs.video.width=$refs.video.width-64" class="text-lg ml-8" title="Verkleinern">
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="magnifying-glass-minus" class="h-8 w-8" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
